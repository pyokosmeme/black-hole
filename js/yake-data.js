...
window.YAKE_ATLAS = {
  worlds: [
    ...
    {id:'shu', name:'Shu / 水', no:'03', kind:'Gas giant · industrial ocean moons', parent:'yake', au:2.142, color:'#a4b9e3',
      ...
      related:['jouki','mizu','pani','buz','dto']},
    {id:'celosia', name:'Celosia', no:'01', kind:'Ocean world · SWI capital', parent:'yake', au:6.13, color:'#6fc6d5', art:'celosia',
      intro:'Three inhabited continents, a cold blue ocean, and the political capital of the Spanning World Independence.',
      ...
      places:[['Fusang','Arctic in the north; Tiantang is cold but arable. The humid south resembles coastal California in temperature.'],['Mu','Northern climate compared to Busan; the south is an intense desert.'],['Diyu','Climate compared to northern Mu and southern Fusang.'],['Tiantang','Capital and major cosmodrome.'],['Yushan City','Named settlement; position not supplied.']],
    ...
    {id:'gullinkambi', name:'Gullinkambi', no:'05', kind:'Outer world · the Golden Comb', parent:'yake', au:51.4, color:'#edc575', art:'gullinkambi',
      ...
      stats:[['Orbit','51.4 AU'],['Population','108.4 million'],['Resonance','Inner 3:2 with Xuan'],['Spin-hab clearance','300+ km from the Comb']],
    ...
    {id:'chanticleer', name:'Chanticleer', no:'06', kind:'Outer world · resonant counterpart', parent:'yake', au:51.4, color:'#bf9ddb',
      ...
      stats:[['Orbit','51.4 AU'],['Population','105.2 million'],['Resonance','Inner 3:2 with Xuan']],
    ...
    {id:'five', name:'Five Islands', no:'07', kind:'Outer settlement group', parent:'yake', au:88.3, color:'#81b5ac',
      intro:'Five named islands of habitation beyond Xuan.',
      stats:[['Orbit','88.3 AU'],['Population','112 million'],['Resonance','Outer 3:2 with Xuan']],
      ...
      places:[['0701 / Mun','Five Islands member'],['0702 / In','Five Islands member'],['0703 / Sin','Five Islands member'],['0704 / Mu','Five Islands member; distinct from Celosia’s continent Mu.'],['0705 / Yong','Five Islands member']], related:['xuan','kukkuta']},
    {id:'kukkuta', name:'Kukkuta', no:'08', kind:'Far outer world', parent:'yake', au:152, color:'#c1abc9',
      ...
      stats:[['Orbit','152 AU'],['Population','20 million']], paragraphs:['Kukkuta extends the inhabited system well beyond Five Islands. Further physical and settlement details have not yet been supplied.'], related:['five']},
    ...
    {id:'skarda', name:'Skarda', kind:'Jin moon · tin', parent:'jin', km:2836675, color:'#85becb',
      intro:'Blue plains, crowded soleriums, and cosmodromes serving Jin’s agricultural economy.',
    ...
    {id:'plomo', name:'Plomo', kind:'Jin moon · lead', parent:'jin', color:'#b5a2ad',
      ...
      places:[['Anchuan Hefushe','Cosmodrome'],['Arco Sweet Water','Cosmodrome'],['Bul Agua Arcbeam','Cosmodrome']], notes:['Orbital radius not supplied; listed outside the scaled moon chart.']},
    ...
    {id:'dajinmen', name:'Dajinmen Ring', kind:'Jin–Ya Ke L5 · arrival control', parent:'jin', color:'#edc575',
    ...
    {id:'marassa', name:'Marassa Jumeaux', kind:'Horizon’s Edge · paired spin habitats', parent:'jin', color:'#c6a2d5',
      intro:'Two connected, counter-rotating rings: Buka grows the food; Chawkee makes, repairs, and trades.',
      stats:[['Hoop radius','1,492 m'],['Structure radius','122 m'],['Gravity','1 g₀'],['Volume per ring','5.48 × 10⁷ m³'],['Location','Near Skarda–Jin L5'],['Offset from L5 center','~180,000 km']],
      paragraphs:['Horizon’s Edge lies at the edge of the quoted exclusion zone. The rings share a working ecology of agriculture, cargo handling, chemical industry, transport, and public space.','Nearby Jin Orbitguard stations, smaller habitat pods, and temporary orbital stays become especially strained when interstellar traffic is ordered to shelter in place. During Ergo, nearly 20,000 people are in orbit nearby.'], related:['buka','chawkee','skarda']},
    ...
    {id:'chawkee', name:'Chawkee / Secundus', kind:'Marassa Jumeaux · industrial ring', parent:'marassa', color:'#9bafe1',
      intro:'An industrial and cultural ring organized around the Central Gap market.', stats:[['Usual population','~55,000'],['Post-Mote population','~75,000'],['Transport layers','People / goods']],
    ...
    {id:'fengsheng', name:'Fengsheng', kind:'Jin system · Vas-L5 flyby', parent:'jin', color:'#a4c9c2', intro:'A recurring close approach to the Vas-L5 neighborhood.', stats:[['Orbital period','6 days 2 hours'],['Flyby interval','~3 days 1 hour'],['Flyby distance','51,200 km']], notes:['The source does not supply a full orbit or a present phase; shown as a location record.'], related:['vas']},
    {id:'dto', name:'DTO', kind:'Shu system · orbital habitat', parent:'shu', color:'#b6b5df', intro:'Day Tey-hab gah Obstaw get Grond Dey.', stats:[['Population in notes','0.336 million']], notes:['Exact orbit and relationship to Shu’s aggregate orbital census are unspecified.'], related:['shu']},
    {id:'celosia-hubs', name:'Celosia L4 / L5', kind:'URAL hub network', parent:'celosia', color:'#76b8c7', intro:'Orbital hubs in the Celosia–Ya Ke Lagrange neighborhoods.', paragraphs:['The source assigns 2.71 million people collectively to URAL hubs around Jin and Celosia. No split between individual L4/L5 locations is supplied.'], related:['celosia','dajinmen']},
  ...
  views: {
    system:{title:'System overview',parent:'yake',unit:'AU',caption:'COMPRESSED ORBIT SPACING · SCHEMATIC PHASES',nodes:[['jin',70,-25],['shu',104,145],['celosia',146,60],['gullinkambi',202,-155],['chanticleer',202,25],['xuan',242,-65],['five',280,160],['kukkuta',316,-15]]},
    jin:{title:'The moons of Jin',parent:'jin',unit:'km',caption:'COMPRESSED MOON ORBITS · DISTANCES FROM JIN',ez:1171000,nodes:[['prata',88,-40],['kobber',160,150],['vas',225,25],['skarda',302,-65]],unplaced:['plomo','suseong','peng']},
    ...
    outer:{title:'Beyond Celosia',parent:'yake',unit:'AU',caption:'RESONANT OUTER WORLDS · SCHEMATIC PHASES',nodes:[['gullinkambi',130,-155],['chanticleer',130,25],['xuan',200,-65],['five',264,155],['kukkuta',318,-10]],unplaced:['kaau','minor']},
    habitats:{title:'Hubs & ring habitats',parent:'yake',caption:'LOCATION HIERARCHY · NO DISTANCE SCALE',nodes:[],members:['dajinmen','fengsheng','marassa','buka','chawkee','dto','celosia-hubs']}
  }
};
