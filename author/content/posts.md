...
## delisting-from-draft2digital
- title: DE-LISTING FROM DRAFT2DIGITAL
- date: 2026.06.20
- tags: publishing, draft2digital, announcements
- file: content/posts/delisting-from-draft2digital.md

D2D is shifting to annual fees, and most of my distribution there was free OverDrive copies. Winding down the account; existing reader libraries should be unaffected.
...
<!--
  ...
  Excerpt text goes here as a regular paragraph.

  NOTE: do not put example ## blocks inside comments — the parser splits
  on ^## /m without stripping HTML comments, so commented examples leak
  into POSTS and their tags leak into the tag filter.
-->
